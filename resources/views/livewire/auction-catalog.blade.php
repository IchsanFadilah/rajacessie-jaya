...
{{--                                </label>--}}
{{--                            </div>--}}
{{--                            <span class="text-xs text-gray-800 font-loght">({{ $item->auction_count }})</span>--}}
{{--                        </div>--}}
{{--                    @endforeach--}}
{{--                </div>--}}
...
{{--                <div class="font-light text-gray-800">Results: {{ $auctions ? $auctions->total() : 'null' }} Items--}}
{{--                </div>--}}
...
<section>
    ...
    <div class="bg-yellow-400">
        <div class="container mx-auto grid grid-cols-1 px-8 py-2 sm:py-6 sm:px-4 gap-5 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 ">
            @forelse ($auctions as $product)
                <x-single-lelang-card :product="$product" />
            @empty
                <div class="col-span-full text-center text-gray-500">
