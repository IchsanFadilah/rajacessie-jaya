<section>
    ...
    <div class="bg-yellow-400">
        <div
            class="container mx-auto grid grid-cols-1 px-8 py-2 sm:py-6 sm:px-4 gap-5 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 ">
