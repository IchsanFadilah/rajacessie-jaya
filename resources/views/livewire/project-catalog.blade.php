...
{{--                                </label>--}}
{{--                            </div>--}}
{{--                            <span class="text-xs text-gray-800 font-loght">({{ $item->project_count }})</span>--}}
{{--                        </div>--}}
{{--                    @endforeach--}}
{{--                </div>--}}
...
{{--                <div class="font-light text-gray-800">Results: {{ $projects ? $projects->total() : 'null' }} Items--}}
{{--                </div>--}}
