            ...
            <div
                ...
                <div class="hs-carousel-slide">
                    <div
                        ...
                        <div class="mt-auto w-2/3 md:max-w-lg ps-32 pb-5 md:ps-40 md:pb-40">
                ...
                <div class="hs-carousel-slide">
                    <div
                        ...
                        bg-cover bg-center bg-no-repeat">
                        <div class="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-40 md:pb-40 justify-end">
                            <div class="mt-5 mx-auto">
                                <a class="sm:py-2 sm:px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-xl bg-emerald-600 border border-transparent text-white hover:bg-emerald-500 focus:outline-hidden focus:bg-gray-100 disabled:opacity-50 disabled:pointer-events-none"
                                    href="#">
                                    Hubungi Kami
                                </a>
                            </div>
