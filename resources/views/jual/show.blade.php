<x-layouts.app>
    <div class="container mx-auto max-w-[85rem] w-full px-4 sm:px-6 lg:px-8 py-10">
        <div>
            <a href="/jual" class="bg-yellow-400 text-black hover:text-white hover:bg-yellow-600 py-2 px-3 rounded-lg">&laquo; Kembali</a>
        </div>
            ...
            <div class="md:col-span-3">
                <div class="flex flex-col gap-2">
                    <div>
                        ...
                        <h3 class="text-xs text-gray-500">{{ $sale->region }}</h3>
                    </div>
