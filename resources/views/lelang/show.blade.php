<x-layouts.app>
    <div class="container mx-auto max-w-[85rem] w-full px-4 sm:px-6 lg:px-8 py-10">
        <div>
            <a href="/lelang" class="bg-yellow-400 text-black hover:text-white hover:bg-yellow-600 py-2 px-3 rounded-lg">&laquo; Kembali</a>
        </div>
        <div class="grid grid-cols-1 gap-10 my-5 md:grid-cols-10">
            <div class="grid grid-cols-1 gap-2 md:col-span-7">
                <div class="w-full">
                    <img src="{{ $auction->thumb_url }}" alt="{{ $auction->name }}"
                         class="object-cover w-full rounded-md aspect-3/2 md:col-span-3">
                    <div class="grid grid-cols-1 gap-2 my-2 md:grid-cols-3 md:col-span-7 w-[800px] h-[600]">
                        @foreach ($auction->gallery as $key => $image)
